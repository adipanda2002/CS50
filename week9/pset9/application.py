...
def buy():
    """Buy shares of stock"""
    if request.method == "POST":
        find_missing_errors = provided("symbol") or provided("shares")
...
def login():
    ...
    if request.method == "POST":
        ...
        result = provided("username") or provided("password")
...
def register():
    if request.method == "POST":
        result = provided("username") or provided("password") or provided("confirmation")
        if result != None:
            return result
